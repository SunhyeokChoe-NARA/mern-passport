...
## Note
* In order to get bcrypt, open cmd(windows CLI) in admin mode then type "npm i --global --production windows-build-tools".
  And back to the vscode, type "npm i -g node-pre-gyp".
  Now U can try this "npm i".
